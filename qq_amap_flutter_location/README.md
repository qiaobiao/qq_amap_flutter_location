...
## 使用高德定位Flutter插件
* 请参考[在Flutter里使用Packages](https://flutter.cn/docs/development/packages-and-plugins/using-packages)， 引入qq_amap_flutter_location插件
...
``` Dart
import 'package:qq_amap_flutter_location/amap_flutter_location.dart';
import 'package: qq_amap_flutter_location/amap_location_option.dart';
```
## 接口说明
