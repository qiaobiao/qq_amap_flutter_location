...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"qq_amap_flutter_location"
    ...
    FlutterEventChannel *eventChanel = [FlutterEventChannel eventChannelWithName:@"qq_amap_flutter_location_stream" binaryMessenger:[registrar messenger]];
