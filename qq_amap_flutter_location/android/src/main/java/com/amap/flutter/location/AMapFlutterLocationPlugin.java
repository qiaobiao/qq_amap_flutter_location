...
public class AMapFlutterLocationPlugin implements FlutterPlugin, MethodCallHandler,
  ...
  private static final String CHANNEL_METHOD_LOCATION = "qq_amap_flutter_location";
  private static final String CHANNEL_STREAM_LOCATION = "qq_amap_flutter_location_stream";
